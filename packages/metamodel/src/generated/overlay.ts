...
export const CONVENTIONS = {
  ...
  sourceDocument: {
    term: "sourceDocument",
    propertyKey: "sourceDocument",
    label: "Source document",
    comment: "The id of the document this element was imported from. Set by intake, and what a later import of the same document matches on to decide whether an element is new, changed, or no longer present. An element without it was drawn by hand and intake will never touch it.",
    values: null,
    defaultValue: null,
    appliesTo: null,
  },
  sourceSection: {
    term: "sourceSection",
    propertyKey: "sourceSection",
    label: "Source section",
    comment: "The slug of the heading this element was written from. A pointer back into the document, so an element's prose can be read in the context it came from. It follows the heading text, so editing a heading changes it — which is why a change to it alone is not treated as a conflict.",
    values: null,
    defaultValue: null,
    appliesTo: null,
  },
